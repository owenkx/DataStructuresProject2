...
public class question9Test {
	...
	public static void main(String[] args) {
		testDataImplementation("BinarySearchTree", "-b", "hamlet.txt");
		testDataImplementation("MoveToFrontList", "-m", "hamlet.txt");
		testDataImplementation("AVLTree", "-a", "hamlet.txt");
		testDataImplementation("HashTable", "-h", "hamlet.txt");
	}
